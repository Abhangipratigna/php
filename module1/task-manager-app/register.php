...
<div class="form-group mt-2 p-2">
<input type="password" name="password" placeholder="Enter your ReEnter Password *" required class="form-control"/>
</div>


<div class="form-group mt-2 p-2">
<input type="text" name="phone" placeholder="Enter your Phone *" required class="form-control"/>
</div>
...
<div class="form-group mt-2 p-2">
<input type="submit" name="register" value="SignUp"  class="btn btn-md btn-primary text-white fs-4 mt-3"/>
<input type="reset" name="reset" value="Reset"  class="btn btn-md btn-danger text-white fs-4 mt-3 ms-2"/>
</div>
